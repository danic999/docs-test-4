...
Fix interoperability with BlinkID by @mijo-gracanin in https://github.com/blinkcard/blinkcard-capacitor/pull/7

**Full Changelog**: https://github.com/blinkcard/blinkcard-capacitor/compare/v2.4.0...v2.4.1
