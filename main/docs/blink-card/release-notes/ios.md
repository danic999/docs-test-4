...
<ul>
<li>We now support landscape orientation on <a href="https://blinkcard.github.io/blinkcard-ios/Classes/MBCBlinkCardEditViewController.html">BlinkCardEditViewController</a> screen</li>
<li>From now on, BlinkCard reads and extracts the expiry date in MM/YYYY format</li>
</ul>
 ...
 * SDK for iOS that enables you to perform scans of various credit or payment cards in your app.
    * For more informtion see the [documentaton](https://blinkcard.github.io/blinkcard-ios/, or the [sample applications](https://github.com/blinkcard/blinkcard-ios/tree/master/Samples).