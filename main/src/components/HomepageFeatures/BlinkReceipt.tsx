  ...
  return (
    <div className="flex flex-1 flex-col h-fit rounded-5xl px-[34px] py-[32px] border bg-white dark:bg-transparent border-gray border-solid shadow group hover:cursor-pointer mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-wrap  gap-[18px] pt-[24px]">
        <a
          href="https://docs.microblink.com/blink-receipt"
        ...
        <span className="text-base md:text-lg text-dark-blue-2 dark:text-[#E7F0FF]">
          Easily capture paper receipts in real-time
        </span>
      </div>
      {/* <div className={`flex flex-col`}>
        <div className="flex flex-col md:flex-row lg:flex-col justify-between">
          <div className="flex flex-col md:flex-wrap text-center pt-[32px]">
            <span className="text-lg font-bold text-dark-blue-2">
              Physical receipts
            </span>
            <UpperLinks type="blinkreceipt" padding="no" centred="yes" />
            <UpperLinks type="blinkreceipt_web" padding="no" centred="yes" />
          </div>

          <div className="flex flex-col text-center pt-[32px]">
            <span className="text-lg font-bold text-dark-blue-2">
              Digital receipt
            </span>
            <UpperLinks
              type="blinkreceipt_digital"
              padding="no"
              centred="yes"
            />
            <UpperLinks
              type="blinkreceipt_digital_web"
              padding="no"
              centred="yes"
            />
          </div>
        ...
        <div className="flex flex-col text-center pt-[32px]">
          ...
          <UpperLinks type="blinkreceipt_account" padding="no" centred="yes" />
        </div>
      </div>*/}
    </div>
  );
