...
export default function CardLinks({ type }) {
  const links_blinkid = [
    {
      icon: ios,
      url: "/docs/blinkid/release-notes/ios/",
      title: "iOS",
    },
    {
      icon: android,
      url: "/docs/blinkid/release-notes/android/",
      title: "Android",
    },
    {
      icon: capacitor,
      url: "/docs/blinkid/release-notes/capacitor/",
      title: "Capacitor",
    },
    {
      icon: cordova,
      url: "/docs/blinkid/release-notes/cordova/",
      title: "Cordova",
    },
    {
      icon: flutter,
      url: "/docs/blinkid/release-notes/flutter/",
      title: "Flutter",
    },
    {
      icon: reactNative,
      url: "/docs/blinkid/release-notes/react-native/",
      title: "React Native",
    },
    {
      icon: selfHosted,
      url: "/docs/blinkid/release-notes/in-browser/",
      title: "In Browser",
    },
  ];
